    ...
    <main className="relative min-h-screen w-full bg-[#0C0D14] overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center md:pt-0">
        <div className="mx-auto px-4 text-center space-y-4">
          ...
          >
            Somos una empresa dinámica e innovadora, capaz de percibir las
            necesidades de nuestros clientes, desarrollando herramientas
            tecnológicas de información y comunicación de alta calidad,
            afrontando cualquier reto que se nos presente.
          </p>
        </div>
      </div>
    </main>
